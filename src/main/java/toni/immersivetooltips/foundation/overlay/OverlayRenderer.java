...
import toni.immersivetooltips.foundation.util.ImmersiveColor;
...
//
        ImmersiveTooltipManager.getRenderer().render(currentTooltip, graphics);
        ImmersiveTooltipManager.getRenderer().render(currentTooltip.subtext, graphics);
