package toni.immersivetooltips.foundation.util;
...
public class ImmersiveColor {
    public final static ImmersiveColor TRANSPARENT_BLACK = new ImmersiveColor(0, 0, 0, 0).setImmutable();
    public final static ImmersiveColor BLACK = new ImmersiveColor(0, 0, 0).setImmutable();
    public final static ImmersiveColor WHITE = new ImmersiveColor(255, 255, 255).setImmutable();
    public final static ImmersiveColor RED = new ImmersiveColor(255, 0, 0).setImmutable();
    public final static ImmersiveColor GREEN = new ImmersiveColor(0, 255, 0).setImmutable();
    public final static ImmersiveColor SPRING_GREEN = new ImmersiveColor(0, 255, 187).setImmutable();
    ...
    public ImmersiveColor copy(boolean mutable) {
        if (mutable)
            return new ImmersiveColor(value);
        else
            return new ImmersiveColor(value).setImmutable();
    }
